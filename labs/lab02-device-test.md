# Create IoT Hub and Configure Sample Device

This tutorial guides you to create an Azure IoT Hub for connecting devices and configure a sample device, using the Azure portal.
